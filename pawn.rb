  ...
  def moves
    ...
    @move_dirs.each do |move_dir|
      ...
      #next if piece is our color or out of bounds
        break unless @board.in_bounds?([new_row, new_col]) && @board[[new_row, new_col]] == NullPiece.instance
    ...
    @attack_move_dirs.each do |move_dir|
      ...
      #next if piece is our color or out of bounds
      next unless @board.in_bounds?([new_row, new_col]) && @board[[new_row, new_col]].color == @opponent_color
      all_moves << [new_row, new_col]
    end
